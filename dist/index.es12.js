...
import { useThree as D } from "./index.es8.js";
import { playerLayer as M } from "./index.es9.js";
import { KeyboardSingleton as B } from "./index.es6.js";
import { GameObjectPhysicalDrawableBase as J } from "./index.es5.js";
import { CapsuleGeometry as g, MeshStandardMaterial as b, Quaternion as P, Vector3 as x } from "./index.es15.js";
class Y extends J {
  constructor(e, r, i) {
    super(e, r);
    t(this, "camera");
  ...
  async setup() {
    ...
    const n = r(() => new g(0.4, 1)), l = i(() => new b({ color: 11184691 }));
  ...
  drawLoopLogic() {
    ...
    this.characterMesh.position.set(e.x, e.y, e.z), this.characterMesh.rotation.setFromQuaternion(new P(r.x, r.y, r.z, r.w));
  }
  physicsLoopLogic(e) {
    const { space: r, keyw: i, keys: a, keya: n, keyd: l, shiftleft: p, menuOpen: y } = B.getKeyboardStateObj();
    if (!y) {
