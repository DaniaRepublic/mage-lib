...
import { WebGLRenderer as R } from "./index.es17.js";
import { OrbitControls as G } from "./index.es18.js";
import { GameBaseClientDebug as z } from "./index.es2.js";
import { KeyboardSingleton as S } from "./index.es6.js";
import { useThree as j } from "./index.es8.js";
import { Physics as J } from "./index.es10.js";
import { Scene as L, PerspectiveCamera as P, PlaneGeometry as I, MeshBasicMaterial as b, BoxGeometry as T, Quaternion as W } from "./index.es15.js";
class q extends z {
  constructor() {
    super();
    i(this, "camera");
  ...
  async setup(o) {
    ...
    const u = new L();
    r.setScene(u), this.camera = new P(60, window.innerWidth / window.innerHeight), this.camera.position.set(0, 5, -10);
  ...
  physicsLoopLogic(o) {
    const { space: s } = S.getKeyboardStateObj();
