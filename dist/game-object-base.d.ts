...
export declare abstract class GameObjectBase implements IGameObjectBase, IServerObjectSetup {
    root: RAPIER.RigidBody;
    userData: TUserData;
...
export declare abstract class GameObjectBaseClient implements IGameObjectBaseClient {
    root: RAPIER.RigidBody;
    userData: TUserData;
    constructor(userData?: TUserData);
    translation(): RAPIER.Vector;
...
export declare abstract class GameObjectPhysicalBase extends GameObjectBase implements IGameObjectPhysicalBase {
    world: RAPIER.World;
...
export declare abstract class GameObjectDrawableBase extends GameObjectBaseClient implements IGameObjectDrawableBase {
    threeResourceManager: ThreeResourceManager;
    constructor(threeResourceManager: ThreeResourceManager, userData?: TUserData);
}
export declare abstract class GameObjectPhysicalDrawableBase extends GameObjectBaseClient implements IGameObjectPhysicalBase, IGameObjectDrawableBase {
    world: RAPIER.World;
    threeResourceManager: ThreeResourceManager;
