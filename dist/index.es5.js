...
function Vl(e, n) {
  ...
  let o = l, h = !1;
  function f(d, A, q, V, Y) {
    let Q = !1;
    const W = R(V, q, A);
    o !== W && (o = W, g(o.object)), Q = x(d, V, q, Y), Q && N(d, V, q, Y), Y !== null && n.update(Y, e.ELEMENT_ARRAY_BUFFER), (Q || h) && (h = !1, m(d, A, q, V), Y !== null && e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, n.get(Y).buffer));
  }
  function C() {
  ...
  function r(d, A) {
    const q = o.newAttributes, V = o.enabledAttributes, Y = o.attributeDivisors;
    q[d] = 1, V[d] === 0 && (e.enableVertexAttribArray(d), V[d] = 1), Y[d] !== A && (e.vertexAttribDivisor(d, A), Y[d] = A);
  }
  function I() {
    const d = o.newAttributes, A = o.enabledAttributes;
    for (let q = 0, V = A.length; q < V; q++)
      A[q] !== d[q] && (e.disableVertexAttribArray(q), A[q] = 0);
  }
  function T(d, A, q, V, Y, Q, W) {
    W === !0 ? e.vertexAttribIPointer(d, A, q, Y, Q) : e.vertexAttribPointer(d, A, q, V, Y, Q);
  }
  function m(d, A, q, V) {
    P();
    const Y = V.attributes, Q = q.getAttributes(), W = A.defaultAttributeValues;
    for (const j in Q) {
      const F = Q[j];
      if (F.location >= 0) {
        let _e = Y[j];
...
const Ht = 4, wi = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], Ut = 20, bn = /* @__PURE__ */ new Wa(), Ii = /* @__PURE__ */ new Ke();
...
class Ni {
  ...
  _allocateTargets() {
    ...
    if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== n || this._pingPongRenderTarget.height !== t) {
      ...
      ({ sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas } = Yl(o)), this._blurMaterial = ql(o, n, t);
    }
    return l;
  }
  _compileMaterial(n) {
...
function jl(e, n, t) {
  ...
  function o(h, f, C) {
    ...
    if (E === void 0 || E.count !== R) {
      ...
      const B = T * 4;
      for (let d = 0; d < R; d++) {
        const A = c[d], q = r[d], V = I[d], Y = m * H * 4 * d;
        for (let Q = 0; Q < A.count; Q++) {
          const W = Q * B;
          x === !0 && (l.fromBufferAttribute(A, Q), U[Y + W + 0] = l.x, U[Y + W + 1] = l.y, U[Y + W + 2] = l.z, U[Y + W + 3] = 0), N === !0 && (l.fromBufferAttribute(q, Q), U[Y + W + 4] = l.x, U[Y + W + 5] = l.y, U[Y + W + 6] = l.z, U[Y + W + 7] = 0), P === !0 && (l.fromBufferAttribute(V, Q), U[Y + W + 8] = l.x, U[Y + W + 9] = l.y, U[Y + W + 10] = l.z, U[Y + W + 11] = V.itemSize === 4 ? l.w : 1);
        }
      }
      E = {
        count: R,
...
const Mr = /* @__PURE__ */ new vr(), Gi = /* @__PURE__ */ new nr(1, 1), Tr = /* @__PURE__ */ new mr(), xr = /* @__PURE__ */ new ja(), Ar = /* @__PURE__ */ new eo(), Hi = [], Vi = [], ki = new Float32Array(16), Wi = new Float32Array(9), zi = new Float32Array(4);
function zt(e, n, t) {
  const i = e[0];
  if (i <= 0 || i > 0) return e;
  const l = n * t;
...
const qi = /* @__PURE__ */ new Be();
function Kc(e) {
  tt._getMatrix(qi, tt.workingColorSpace, e);
  const n = `mat3( ${qi.elements.map((t) => t.toFixed(4))} )`;
...
` + r);
  ...
  function y(A) {
    if (e.debug.checkShaderErrors) {
      const q = l.getProgramInfoLog(P).trim(), V = l.getShaderInfoLog(H).trim(), Y = l.getShaderInfoLog(U).trim();
      let Q = !0, W = !0;
      if (l.getProgramParameter(P, l.LINK_STATUS) === !1)
        if (Q = !1, typeof e.debug.onShaderError == "function")
          e.debug.onShaderError(l, P, H, U);
        else {
          const j = Ki(l, H, "vertex"), F = Ki(l, U, "fragment");
          console.error(
...
` + F
      ...
      else q !== "" ? console.warn("THREE.WebGLProgram: Program Info Log:", q) : (V === "" || Y === "") && (W = !1);
      W && (A.diagnostics = {
        runnable: Q,
        programLog: q,
        vertexShader: {
...
function mf(e, n, t, i, l, o, h) {
  ...
  function c(p, d, A, q, V) {
    const Y = q.fog, Q = V.geometry, W = p.isMeshStandardMaterial ? q.environment : null, j = (p.isMeshStandardMaterial ? t : n).get(p.envMap || W), F = j && j.mapping === vn ? j.image.height : null, _e = N[p.type];
...
function Af(e) {
  ...
  function f(g) {
    ...
    for (let p = 0, d = g.length; p < d; p++) {
      const A = g[p], q = A.color, V = A.intensity, Y = A.distance, Q = A.shadow && A.shadow.map ? A.shadow.map.texture : null;
      if (A.isAmbientLight)
        b += q.r * V, R += q.g * V, E += q.b * V;
        ...
        const W = n.get(A);
        W.position.setFromMatrixPosition(A.matrixWorld), W.color.copy(q).multiplyScalar(V), W.distance = Y, W.coneCos = Math.cos(A.angle), W.penumbraCos = Math.cos(A.angle * (1 - A.penumbra)), W.decay = A.decay, i.spot[P] = W;
        const j = A.shadow;
        ...
        const W = n.get(A);
        W.color.copy(q).multiplyScalar(V), W.halfWidth.set(A.width * 0.5, 0, 0), W.halfHeight.set(0, A.height * 0.5, 0), i.rectArea[c] = W, c++;
...
function Pf(e, n, t) {
  ...
  this.render = function(U, y, B) {
    ...
    const p = e.getRenderTarget(), d = e.getActiveCubeFace(), A = e.getActiveMipmapLevel(), q = e.state;
    q.setBlending(wt), q.buffers.color.setClear(1, 1, 1, 1), q.buffers.depth.setTest(!0), q.setScissorTest(!1);
    ...
    for (let Q = 0, W = U.length; Q < W; Q++) {
      ...
      for (let Le = 0; Le < Me; Le++) {
        ...
        h.set(
          ...
          o.x * Ge.z,
          o.y * Ge.w
        ), q.viewport(h), F.updateMatrices(j, Le), i = F.getFrustum(), m(y, B, F.camera, j, this.type);
      }
...
function Uf(e, n) {
  ...
  let b = {}, R = {}, E = /* @__PURE__ */ new WeakMap(), x = [], N = null, P = !1, c = null, r = null, I = null, T = null, m = null, H = null, U = null, y = new Ke(0, 0, 0), B = 0, p = !1, d = null, A = null, q = null, V = null, Y = null;
  ...
  function ze() {
    e.disable(e.BLEND), e.disable(e.CULL_FACE), e.disable(e.DEPTH_TEST), e.disable(e.POLYGON_OFFSET_FILL), e.disable(e.SCISSOR_TEST), e.disable(e.STENCIL_TEST), e.disable(e.SAMPLE_ALPHA_TO_COVERAGE), e.blendEquation(e.FUNC_ADD), e.blendFunc(e.ONE, e.ZERO), e.blendFuncSeparate(e.ONE, e.ZERO, e.ONE, e.ZERO), e.blendColor(0, 0, 0, 0), e.colorMask(!0, !0, !0, !0), e.clearColor(0, 0, 0, 0), e.depthMask(!0), e.depthFunc(e.LESS), h.setReversed(!1), e.clearDepth(1), e.stencilMask(4294967295), e.stencilFunc(e.ALWAYS, 0, 4294967295), e.stencilOp(e.KEEP, e.KEEP, e.KEEP), e.clearStencil(0), e.cullFace(e.BACK), e.frontFace(e.CCW), e.polygonOffset(0, 0), e.activeTexture(e.TEXTURE0), e.bindFramebuffer(e.FRAMEBUFFER, null), e.bindFramebuffer(e.DRAW_FRAMEBUFFER, null), e.bindFramebuffer(e.READ_FRAMEBUFFER, null), e.useProgram(null), e.lineWidth(1), e.scissor(0, 0, e.canvas.width, e.canvas.height), e.viewport(0, 0, e.canvas.width, e.canvas.height), b = {}, _e = null, Me = {}, R = {}, E = /* @__PURE__ */ new WeakMap(), x = [], N = null, P = !1, c = null, r = null, I = null, T = null, m = null, H = null, U = null, y = new Ke(0, 0, 0), B = 0, p = !1, d = null, A = null, q = null, V = null, Y = null, Ze.set(0, 0, e.canvas.width, e.canvas.height), k.set(0, 0, e.canvas.width, e.canvas.height), o.reset(), h.reset(), f.reset();
  }
  return {
    buffers: {
      color: o,
...
function Df(e, n, t, i, l, o, h) {
  ...
  function P(u, a, L) {
    let z = 1;
    const K = he(u);
    if ((K.width > L || K.height > L) && (z = L / Math.max(K.width, K.height)), z < 1)
      if (typeof HTMLImageElement < "u" && u instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && u instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && u instanceof ImageBitmap || typeof VideoFrame < "u" && u instanceof VideoFrame) {
        const G = Math.floor(z * K.width), pe = Math.floor(z * K.height);
        R === void 0 && (R = N(G, pe));
        const re = a ? N(G, pe) : R;
        ...
        return "data" in u && console.warn("THREE.WebGLRenderer: Image in DataTexture is too big (" + K.width + "x" + K.height + ")."), u;
    return u;
  }
  function c(u) {
  ...
  function T(u, a, L, z, K = !1) {
    ...
    if (a === e.RED && (L === e.FLOAT && (G = e.R32F), L === e.HALF_FLOAT && (G = e.R16F), L === e.UNSIGNED_BYTE && (G = e.R8)), a === e.RED_INTEGER && (L === e.UNSIGNED_BYTE && (G = e.R8UI), L === e.UNSIGNED_SHORT && (G = e.R16UI), L === e.UNSIGNED_INT && (G = e.R32UI), L === e.BYTE && (G = e.R8I), L === e.SHORT && (G = e.R16I), L === e.INT && (G = e.R32I)), a === e.RG && (L === e.FLOAT && (G = e.RG32F), L === e.HALF_FLOAT && (G = e.RG16F), L === e.UNSIGNED_BYTE && (G = e.RG8)), a === e.RG_INTEGER && (L === e.UNSIGNED_BYTE && (G = e.RG8UI), L === e.UNSIGNED_SHORT && (G = e.RG16UI), L === e.UNSIGNED_INT && (G = e.RG32UI), L === e.BYTE && (G = e.RG8I), L === e.SHORT && (G = e.RG16I), L === e.INT && (G = e.RG32I)), a === e.RGB_INTEGER && (L === e.UNSIGNED_BYTE && (G = e.RGB8UI), L === e.UNSIGNED_SHORT && (G = e.RGB16UI), L === e.UNSIGNED_INT && (G = e.RGB32UI), L === e.BYTE && (G = e.RGB8I), L === e.SHORT && (G = e.RGB16I), L === e.INT && (G = e.RGB32I)), a === e.RGBA_INTEGER && (L === e.UNSIGNED_BYTE && (G = e.RGBA8UI), L === e.UNSIGNED_SHORT && (G = e.RGBA16UI), L === e.UNSIGNED_INT && (G = e.RGBA32UI), L === e.BYTE && (G = e.RGBA8I), L === e.SHORT && (G = e.RGBA16I), L === e.INT && (G = e.RGBA32I)), a === e.RGB && L === e.UNSIGNED_INT_5_9_9_9_REV && (G = e.RGB9_E5), a === e.RGBA) {
      const pe = K ? Er : tt.getTransfer(z);
  ...
  function B(u) {
    ...
    if (z) {
      const K = z[a.__cacheKey];
      K.usedTimes--, K.usedTimes === 0 && p(u), Object.keys(z).length === 0 && E.delete(L);
    }
    i.remove(u);
  }
  function p(u) {
    ...
    if (u.depthTexture && (u.depthTexture.dispose(), i.remove(u.depthTexture)), u.isWebGLCubeRenderTarget)
      for (let z = 0; z < 6; z++) {
        if (Array.isArray(a.__webglFramebuffer[z]))
          for (let K = 0; K < a.__webglFramebuffer[z].length; K++) e.deleteFramebuffer(a.__webglFramebuffer[z][K]);
        else
  ...
  function Ge(u, a) {
    if (a.type === Dt && n.has("OES_texture_float_linear") === !1 && (a.magFilter === Gt || a.magFilter === Mn || a.magFilter === nn || a.magFilter === qt || a.minFilter === Gt || a.minFilter === Mn || a.minFilter === nn || a.minFilter === qt) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), e.texParameteri(u, e.TEXTURE_WRAP_S, _e[a.wrapS]), e.texParameteri(u, e.TEXTURE_WRAP_T, _e[a.wrapT]), (u === e.TEXTURE_3D || u === e.TEXTURE_2D_ARRAY) && e.texParameteri(u, e.TEXTURE_WRAP_R, _e[a.wrapR]), e.texParameteri(u, e.TEXTURE_MAG_FILTER, Me[a.magFilter]), e.texParameteri(u, e.TEXTURE_MIN_FILTER, Me[a.minFilter]), a.compareFunction && (e.texParameteri(u, e.TEXTURE_COMPARE_MODE, e.COMPARE_REF_TO_TEXTURE), e.texParameteri(u, e.TEXTURE_COMPARE_FUNC, Le[a.compareFunction])), n.has("EXT_texture_filter_anisotropic") === !0) {
      if (a.magFilter === $t || a.minFilter !== nn && a.minFilter !== qt || a.type === Dt && n.has("OES_texture_float_linear") === !1) return;
  ...
  function Ze(u, a) {
    ...
    const z = a.source;
    let K = E.get(z);
    K === void 0 && (K = {}, E.set(z, K));
    const G = Y(a);
    if (G !== u.__cacheKey) {
      K[G] === void 0 && (K[G] = {
        texture: e.createTexture(),
        usedTimes: 0
      }, h.memory.textures++, L = !0), K[G].usedTimes++;
      const pe = K[u.__cacheKey];
  ...
  function k(u, a, L) {
    ...
    if (G.version !== pe.__version || K === !0) {
      ...
      Ge(z, a);
      let fe;
      const Ie = a.mipmaps, be = a.isVideoTexture !== !0, ze = pe.__version === void 0 || K === !0, v = G.dataReady, te = H(a, Z);
      if (a.isDepthTexture)
  ...
  function J(u, a, L) {
    ...
    if (K.version !== G.__version || z === !0) {
      ...
      const Ee = ce[0], Te = o.convert(a.format, a.colorSpace), fe = o.convert(a.type), Ie = T(a.internalFormat, Te, fe, a.colorSpace), be = a.isVideoTexture !== !0, ze = G.__version === void 0 || z === !0, v = K.dataReady;
      let te = H(a, Ee);
      ...
      c(a) && r(e.TEXTURE_CUBE_MAP), G.__version = K.version, a.onUpdate && a.onUpdate(a);
    }
    u.__version = a.version;
  }
  function ue(u, a, L, z, K, G) {
    ...
    if (Z.__renderTarget = a, !Ne.__hasExternalTextures) {
      ...
      K === e.TEXTURE_3D || K === e.TEXTURE_2D_ARRAY ? t.texImage3D(K, G, le, ce, Ee, a.depth, 0, pe, re, null) : t.texImage2D(K, G, le, ce, Ee, 0, pe, re, null);
    }
    t.bindFramebuffer(e.FRAMEBUFFER, u), we(a) ? f.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, z, K, Z.__webglTexture, 0, De(a)) : (K === e.TEXTURE_2D || K >= e.TEXTURE_CUBE_MAP_POSITIVE_X && K <= e.TEXTURE_CUBE_MAP_NEGATIVE_Z) && e.framebufferTexture2D(e.FRAMEBUFFER, z, K, Z.__webglTexture, G), t.bindFramebuffer(e.FRAMEBUFFER, null);
  }
  function ie(u, a, L) {
    if (e.bindRenderbuffer(e.RENDERBUFFER, u), a.depthBuffer) {
      const z = a.depthTexture, K = z && z.isDepthTexture ? z.type : null, G = m(a.stencilBuffer, K), pe = a.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT, re = De(a);
      ...
      for (let K = 0; K < z.length; K++) {
        const G = z[K], pe = o.convert(G.format, G.colorSpace), re = o.convert(G.type), le = T(G.internalFormat, pe, re, G.colorSpace), Ne = De(a);
  ...
  function Se(u, a) {
    ...
    const K = z.__webglTexture, G = De(a);
    if (a.depthTexture.format === zn)
      we(a) ? f.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, e.DEPTH_ATTACHMENT, e.TEXTURE_2D, K, 0, G) : e.framebufferTexture2D(e.FRAMEBUFFER, e.DEPTH_ATTACHMENT, e.TEXTURE_2D, K, 0);
    else if (a.depthTexture.format === un)
      we(a) ? f.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, e.DEPTH_STENCIL_ATTACHMENT, e.TEXTURE_2D, K, 0, G) : e.framebufferTexture2D(e.FRAMEBUFFER, e.DEPTH_STENCIL_ATTACHMENT, e.TEXTURE_2D, K, 0);
    else
  ...
  function Ae(u) {
    ...
    if (a.__boundDepthTexture !== u.depthTexture) {
      ...
      if (a.__depthDisposeCallback && a.__depthDisposeCallback(), z) {
        const K = () => {
          delete a.__boundDepthTexture, delete a.__depthDisposeCallback, z.removeEventListener("dispose", K);
        };
        z.addEventListener("dispose", K), a.__depthDisposeCallback = K;
      }
    ...
    if (u.depthTexture && !a.__autoAllocateDepthBuffer) {
      ...
      for (let z = 0; z < 6; z++)
        if (t.bindFramebuffer(e.FRAMEBUFFER, a.__webglFramebuffer[z]), a.__webglDepthbuffer[z] === void 0)
          ...
          const K = u.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT, G = a.__webglDepthbuffer[z];
      ...
      const z = u.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT, K = a.__webglDepthbuffer;
      e.bindRenderbuffer(e.RENDERBUFFER, K), e.framebufferRenderbuffer(e.FRAMEBUFFER, z, e.RENDERBUFFER, K);
    }
  ...
  function $e(u) {
    ...
    const K = u.textures, G = u.isWebGLCubeRenderTarget === !0, pe = K.length > 1;
    if (pe || (z.__webglTexture === void 0 && (z.__webglTexture = e.createTexture()), z.__version = a.version, h.memory.textures++), G) {
      ...
      if (pe)
        for (let re = 0, le = K.length; re < le; re++) {
          const Ne = i.get(K[re]);
  ...
  function ye(u) {
    ...
    for (let L = 0, z = a.length; L < z; L++) {
      const K = a[L];
      if (c(K)) {
        const G = I(u), pe = i.get(K).__webglTexture;
    ...
    if (u.samples > 0) {
      if (we(u) === !1) {
        ...
        for (let le = 0; le < a.length; le++) {
          ...
          e.blitFramebuffer(0, 0, L, z, 0, 0, L, z, K, e.NEAREST), C === !0 && (je.length = 0, _.length = 0, je.push(e.COLOR_ATTACHMENT0 + le), u.depthBuffer && u.resolveDepthBuffer === !1 && (je.push(G), _.push(G), e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, _)), e.invalidateFramebuffer(e.READ_FRAMEBUFFER, je));
        }
  ...
  function Xe(u, a) {
    const L = u.colorSpace, z = u.format, K = u.type;
    return u.isCompressedTexture === !0 || u.isVideoTexture === !0 || L !== mn && L !== Bt && (tt.getTransfer(L) === Ye ? (z !== Tt || K !== It) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", L)), a;
  }
  function he(u) {
  ...
  this.allocateTextureUnit = V, this.resetTextureUnits = q, this.setTexture2D = Q, this.setTexture2DArray = W, this.setTexture3D = j, this.setTextureCube = F, this.rebindTextures = Ue, this.setupRenderTarget = $e, this.updateRenderTargetMipmap = ye, this.updateMultisampleRenderTarget = ut, this.setupDepthRenderbuffer = Ae, this.setupFrameBufferTexture = ue, this.useMultisampledRTT = we;
}
function wf(e, n) {
  function t(i, l = Bt) {
    let o;
...
class Ff extends Br {
  constructor(n, t) {
    ...
    function Y() {
      ...
      A = null, q = null, P.reset(), n.setRenderTarget(r), x = null, E = null, R = null, l = null, I = null, Ze.stop(), i.isPresenting = !1, n.setPixelRatio(U), n.setSize(H.width, H.height, !1), i.dispatchEvent({ type: "sessionend" });
    }
        ...
        if (r = n.getRenderTarget(), l.addEventListener("select", V), l.addEventListener("selectstart", V), l.addEventListener("selectend", V), l.addEventListener("squeeze", V), l.addEventListener("squeezestart", V), l.addEventListener("squeezeend", V), l.addEventListener("end", Y), l.addEventListener("inputsourceschange", Q), c.xrCompatible !== !0 && await t.makeXRCompatible(), U = n.getPixelRatio(), n.getSize(H), l.enabledFeatures !== void 0 && l.enabledFeatures.includes("layers")) {
          ...
          R = new XRWebGLBinding(l, t), E = R.createProjectionLayer(Ae), l.updateRenderState({ layers: [E] }), n.setPixelRatio(1), n.setSize(E.textureWidth, E.textureHeight, !1), I = new Vt(
            ...
            E.textureHeight,
            {
              format: Tt,
              type: It,
              depthTexture: new nr(E.textureWidth, E.textureHeight, ie, void 0, void 0, void 0, void 0, void 0, void 0, ue),
    ...
    function F(k, J, ue) {
      ...
      if (J.matrixWorld.decompose(k.position, k.quaternion, k.scale), k.translateX(Xe), k.translateZ(me), k.matrixWorld.compose(k.position, k.quaternion, k.scale), k.matrixWorldInverse.copy(k.matrixWorld).invert(), Se[10] === -1)
        ...
        const he = Ue + me, u = $e + me, a = De - Xe, L = we + (ie - Xe), z = ye * $e / u * he, K = je * $e / u * he;
        k.projectionMatrix.makePerspective(a, L, z, K, he, u), k.projectionMatrixInverse.copy(k.projectionMatrix).invert();
      }
    }
    function _e(k, J) {
    ...
    this.updateCamera = function(k) {
      ...
      P.texture !== null && (P.depthNear > 0 && (J = P.depthNear), P.depthFar > 0 && (ue = P.depthFar)), d.near = B.near = y.near = J, d.far = B.far = y.far = ue, (A !== d.near || q !== d.far) && (l.updateRenderState({
        depthNear: d.near,
        depthFar: d.far
      }), A = d.near, q = d.far), y.layers.mask = k.layers.mask | 2, B.layers.mask = k.layers.mask | 4, d.layers.mask = y.layers.mask | B.layers.mask;
  ...
  function E(I) {
    ...
    for (let U = 0, y = m.length; U < y; U++) {
      ...
      for (let p = 0, d = B.length; p < d; p++) {
        const A = B[p];
        if (x(A, U, p, H) === !0) {
          const q = A.__offset, V = Array.isArray(A.value) ? A.value : [A.value];
          let Y = 0;
          for (let Q = 0; Q < V.length; Q++) {
            const W = V[Q], j = P(W);
            typeof W == "number" || typeof W == "boolean" ? (A.__data[0] = W, e.bufferSubData(e.UNIFORM_BUFFER, q + Y, A.__data)) : W.isMatrix3 ? (A.__data[0] = W.elements[0], A.__data[1] = W.elements[1], A.__data[2] = W.elements[2], A.__data[3] = 0, A.__data[4] = W.elements[3], A.__data[5] = W.elements[4], A.__data[6] = W.elements[5], A.__data[7] = 0, A.__data[8] = W.elements[6], A.__data[9] = W.elements[7], A.__data[10] = W.elements[8], A.__data[11] = 0) : (W.toArray(A.__data, Y), Y += j.storage / Float32Array.BYTES_PER_ELEMENT);
          }
  ...
  function N(I) {
    ...
    for (let y = 0, B = T.length; y < B; y++) {
      ...
      for (let d = 0, A = p.length; d < A; d++) {
        const q = p[d], V = Array.isArray(q.value) ? q.value : [q.value];
        for (let Y = 0, Q = V.length; Y < Q; Y++) {
          const W = V[Y], j = P(W), F = m % H, _e = F % j.boundary, Me = F + _e;
          m += _e, Me !== 0 && H - Me < j.storage && (m += H - Me), q.__data = new Float32Array(j.storage / Float32Array.BYTES_PER_ELEMENT), q.__offset = m, m += j.storage;
        }
      }
    }
    const U = m % H;
...
class kf {
  constructor(n = {}) {
    ...
    this.xr = O, this.getContext = function() {
      ...
      s.isVector4 ? Ge.set(s.x, s.y, s.z, s.w) : Ge.set(s, S, D, w), me.scissor(q.copy(Ge).multiplyScalar(F).round());
    ...
    this.renderBufferDirect = function(s, S, D, w, M, $) {
      ...
      let de = D.index, xe = 1;
      if (w.wireframe === !0) {
        if (de = K.getWireframeAttribute(D), de === void 0) return;
        xe = 2;
      }
    ...
    Rt.setAnimationLoop(Et), typeof self < "u" && Rt.setContext(self), this.setAnimationLoop = function(s) {
    ...
    }, O.addEventListener("sessionstart", Yn), O.addEventListener("sessionend", qn), this.render = function(s, S) {
      ...
      if (r.setupLights(), S.isArrayCamera) {
        ...
        M.length > 0 && $n(w, M, s, S), ye && Ee.render(s), Kn(c, s, S);
    ...
    function Rr(s, S, D, w, M) {
      ...
      Ve === !0 && (vt = tn(w, S, M));
      let Nt = !1, dt = !1, Xt = !1;
      const qe = vt.getUniforms(), pt = ge.uniforms;
      if (me.useProgram(vt.program) && (Nt = !0, dt = !0, Xt = !0), w.id !== p && (p = w.id, dt = !0), Nt || d !== s) {
        me.buffers.depth.getReversed() ? (ie.copy(s.projectionMatrix), yr(ie), Nr(ie), qe.setValue(_, "projectionMatrix", ie)) : qe.setValue(_, "projectionMatrix", s.projectionMatrix), qe.setValue(_, "viewMatrix", s.matrixWorldInverse);
        const st = qe.map.cameraPosition;
        st !== void 0 && st.setValue(_, Ae.setFromMatrixPosition(s.matrixWorld)), we.logarithmicDepthBuffer && qe.setValue(
          _,
          "logDepthBufFC",
          2 / (Math.log(s.far + 1) / Math.LN2)
        ), (w.isMeshPhongMaterial || w.isMeshToonMaterial || w.isMeshLambertMaterial || w.isMeshBasicMaterial || w.isMeshStandardMaterial || w.isShaderMaterial) && qe.setValue(_, "isOrthographic", s.isOrthographicCamera === !0), d !== s && (d = s, dt = !0, Xt = !0);
      }
      if (M.isSkinnedMesh) {
        qe.setOptional(_, M, "bindMatrix"), qe.setOptional(_, M, "bindMatrixInverse");
        const ot = M.skeleton;
        ot && (ot.boneTexture === null && ot.computeBoneTexture(), qe.setValue(_, "boneTexture", ot.boneTexture, u));
      }
      M.isBatchedMesh && (qe.setOptional(_, M, "batchingTexture"), qe.setValue(_, "batchingTexture", M._matricesTexture, u), qe.setOptional(_, M, "batchingIdTexture"), qe.setValue(_, "batchingIdTexture", M._indirectTexture, u), qe.setOptional(_, M, "batchingColorTexture"), M._colorsTexture !== null && qe.setValue(_, "batchingColorTexture", M._colorsTexture, u));
      const ht = D.morphAttributes;
      if ((ht.position !== void 0 || ht.normal !== void 0 || ht.color !== void 0) && Te.update(M, D, vt), (dt || ge.receiveShadow !== M.receiveShadow) && (ge.receiveShadow = M.receiveShadow, qe.setValue(_, "receiveShadow", M.receiveShadow)), w.isMeshGouraudMaterial && w.envMap !== null && (pt.envMap.value = de, pt.flipEnvMap.value = de.isCubeTexture && de.isRenderTargetTexture === !1 ? -1 : 1), w.isMeshStandardMaterial && w.envMap === null && S.environment !== null && (pt.envMapIntensity.value = S.environmentIntensity), dt && (qe.setValue(_, "toneMappingExposure", m.toneMappingExposure), ge.needsLights && Cr(pt, Xt), $ && w.fog === !0 && re.refreshFogUniforms(pt, $), re.refreshMaterialUniforms(pt, w, F, j, r.state.transmissionRenderTarget[s.id]), dn.upload(_, Qn(ge), pt, u)), w.isShaderMaterial && w.uniformsNeedUpdate === !0 && (dn.upload(_, Qn(ge), pt, u), w.uniformsNeedUpdate = !1), w.isSpriteMaterial && qe.setValue(_, "center", M.center), qe.setValue(_, "modelViewMatrix", M.modelViewMatrix), qe.setValue(_, "normalMatrix", M.normalMatrix), qe.setValue(_, "modelMatrix", M.matrixWorld), w.isShaderMaterial || w.isRawShaderMaterial) {
    ...
    this.setRenderTarget = function(s, S = 0, D = 0) {
      ...
      if (s) {
        ...
        s.isWebGLCubeRenderTarget ? (Array.isArray(Re[S]) ? M = Re[S][D] : M = Re[S], $ = !0) : s.samples > 0 && u.useMultisampledRTT(s) === !1 ? M = he.get(s).__webglMultisampledFramebuffer : Array.isArray(Re) ? M = Re[D] : M = Re, A.copy(s.viewport), q.copy(s.scissor), V = s.scissorTest;
      } else
        A.copy(Le).multiplyScalar(F).floor(), q.copy(Ge).multiplyScalar(F).floor(), V = Ze;
      if (D !== 0 && (M = Pr), me.bindFramebuffer(_.FRAMEBUFFER, M) && w && me.drawBuffers(s, M), me.viewport(A), me.scissor(q), me.setScissorTest(V), $) {
    ...
    this.copyTextureToTexture = function(s, S, D = null, w = null, M = 0, $ = null) {
      ...
      const qe = s.isDataArrayTexture || s.isData3DTexture, pt = S.isDataArrayTexture || S.isData3DTexture;
      if (s.isDepthTexture) {
        ...
        for (let Ct = 0; Ct < de; Ct++)
          qe && (_.framebufferTextureLayer(_.READ_FRAMEBUFFER, _.COLOR_ATTACHMENT0, he.get(s).__webglTexture, M, ve + Ct), _.framebufferTextureLayer(_.DRAW_FRAMEBUFFER, _.COLOR_ATTACHMENT0, he.get(S).__webglTexture, $, et + Ct)), _.blitFramebuffer(xe, Re, ne, se, Oe, He, ne, se, _.DEPTH_BUFFER_BIT, _.NEAREST);
...
export {
  ...
  nd as Light,
  id as Line,
  rd as LineBasicMaterial,
  ad as LineSegments,
  Gt as LinearFilter,
  qt as LinearMipmapLinearFilter,
